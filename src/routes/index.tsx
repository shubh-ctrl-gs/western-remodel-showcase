    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-12 gap-10">
            <div className="col-span-8">
              <h1 className="hero-h1">
                <span className="upper">WMFR</span> has set the standard for our
                ability to{" "}
                <span className="accent-word">Fast-Track</span> comprehensive
                CAPEX interior remodel on Large, up to{" "}
                <span className="accent-word">1200+ unit</span>, multi-family
                projects,{" "}
                <span className="accent-word">WHILE OCCUPIED.</span>
              </h1>
            </div>
            <div className="col-span-4 flex flex-col justify-center">
              <div className="highlight-box p-6">
                <p className="text-sm leading-relaxed">
                  Completing{" "}
                  <span className="stat text-2xl">3 units</span> PER Trade Per
                  Day, we reduced the original projected length of the project
                  by{" "}
          ...
          <div className="mt-12 grid grid-cols-12 gap-10 border-t border-border pt-10">
            <div className="col-span-8">
              <p className="body-copy">
                In partnership with{" "}
                <strong>AvalonBay Communities</strong>, Western Multi-Family
                Remodel took on the full interior renovation of{" "}
                <strong>AVA Toluca Hills</strong> — a 1,200+ unit garden-style
                community in the heart of Los Angeles. The scope spanned every
                unit interior: full kitchen and bath rebuilds, flooring,
                millwork, paint, and fixtures — executed entirely{" "}
                <strong>while the community remained occupied</strong>.
              </p>
              <p className="body-copy mt-5">
                Our self-performing trade crews, sequenced logistics, and
                same-unit daily turnover model let us complete{" "}
                <strong>3 units per trade per day</strong> — compressing a
                schedule originally projected at nearly three years into{" "}
                <strong>under 19 months</strong>. The result: 1,151 units
                delivered to spec, on time, with zero displaced residents.
              </p>
            </div>
      ...
      <section id="portfolio" className="drone-section h-[600px] w-full">
        ...
        <div className="absolute left-7 bottom-7 z-10 text-white/70">
          <div className="eyebrow text-[0.62rem] text-amber-soft">
            Orthomosaic Site Survey
          </div>
